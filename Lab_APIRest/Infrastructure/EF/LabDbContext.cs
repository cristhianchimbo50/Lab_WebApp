...
public partial class LabDbContext : DbContext
{
    ...
    public virtual DbSet<tokens_usuarios> tokens_usuarios { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.id_token).HasName("PK_tokens_usuarios");
            ...
            entity.Property(e => e.token_hash).HasColumnName("token_hash").HasColumnType("varbinary(32)");
            entity.Property(e => e.tipo_token).HasColumnName("tipo_token").HasMaxLength(20);
            entity.Property(e => e.fecha_solicitud).HasColumnName("fecha_solicitud").HasColumnType("datetime2(0)").HasDefaultValueSql("SYSUTCDATETIME()");
            entity.Property(e => e.fecha_expiracion).HasColumnName("fecha_expiracion").HasColumnType("datetime2(0)");
            entity.Property(e => e.usado).HasColumnName("usado").HasDefaultValue(false);
            entity.Property(e => e.usado_en).HasColumnName("usado_en").HasColumnType("datetime2(0)");
            entity.Property(e => e.ip_solicitud).HasColumnName("ip_solicitud").HasMaxLength(45);
            entity.Property(e => e.user_agent).HasColumnName("user_agent").HasMaxLength(256);

            entity.HasIndex(e => new { e.id_usuario, e.usado }).HasDatabaseName("IX_tokens_usuario_usado");
            entity.HasIndex(e => e.fecha_expiracion).HasDatabaseName("IX_tokens_expiracion");
